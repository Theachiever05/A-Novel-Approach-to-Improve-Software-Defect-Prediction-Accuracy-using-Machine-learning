...
urlpatterns = [
    ...
    url(r'^Predict_Software_Defect_Type/$', remoteuser.Predict_Software_Defect_Type, name="Predict_Software_Defect_Type"),
    ...
    url(r'^View_Prediction_Of_Software_Defect_Type_Ratio/$', serviceprovider.View_Prediction_Of_Software_Defect_Type_Ratio, name="View_Prediction_Of_Software_Defect_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Software_Defect_Type/$', serviceprovider.View_Prediction_Of_Software_Defect_Type, name="View_Prediction_Of_Software_Defect_Type"),
